  ...
  <div class="main-wrapper">
    <div class="row">
      ...
      <div class="col-5 left-side">
        ...
        <div :class="(ad.needHelp === true) ? ' adlist-wrapper blue' : 'adlist-wrapper green'"
      ...
      <div class="col-5 right-side">
        <div class="adWrapper" v-if="choosenAd.title != undefined">
          ...
          <div class="adWrapper-details">
            ...
            <button @click="$bvModal.show('addAd')" class="getTaskButton">Edit</button>
          </div>
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    async getAdvertisementsFromDb() {
      let result = await apiRequest(endpoints.getMyAds, "GET");
      console.log(result);
